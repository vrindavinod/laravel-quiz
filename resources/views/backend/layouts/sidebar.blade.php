                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="{{route('question.index')}}"><i class="menu-icon icon-inbox"></i>View Questions </a></li>
                            </ul>
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="{{route('user.index')}}"><i class="menu-icon icon-inbox"></i>View Users </a></li>
                            </ul>
                        ...
                        <ul class="widget widget-menu unstyled">
                            ...
                            <li><a href="{{route('view.exam')}}"><i class="menu-icon icon-inbox"></i>View Exams </a></li>
                        </ul>
